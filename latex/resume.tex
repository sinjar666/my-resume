...
\definecolor{LightGrey}{HTML}{403d3d}
% \colorlet{name}{black}
...
\textbf{12 years} of official experience with Software Development, a decade more otherwise!
...
\cvachievement{\faTrophy}{Portfolio}{Grew India team's portfolio by \textbf{2x in 2 years} despite the same number of engineers}
