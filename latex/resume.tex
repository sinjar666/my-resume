...
12 years of official experience with Software Development, a decade more otherwise!
...
\cvevent{Senior Engineer}{}{}{}
\cvevent{Software Engineer}{}{}{}
\cvevent{Project Trainee}{Honeywell Technology Solutions}{Dec 2012 -- Jan 2017}{Bengaluru, IN}
\begin{itemize}
...
\cvachievement{\faChartLine}{Product Maturity}{from 100s of automation runs in a year to over 10M in FY-23}

\divider

\cvachievement{\faCheck}{Manager effectiveness}{100\% manager effectiveness score in FY-23 anonymous employee survey}

\divider

\cvachievement{\faTrophy}{Portfolio}{Grew India team's portfolio by 2x in 2 years despite the same number of engineers}

\divider

\cvachievement{\faQuestion}{Growth Mindset}{A positive attitude towards change and continuous learning has helped me adapt to every new role and domain. Have changed tech stacks, roles, and domains across my experience.}
...
\cvskill{English}{5}
\cvskill{Hindi}{4}
\cvskill{Telugu}{3.5} %% supports X.5 values.
\cvskill{Bengali}{3} %% supports X.5 values.
\cvskill{Kannada}{3} %% supports X.5 values.

\cvsection{Education}

\cvevent{B. Tech\ in Computer Science}{SRM University}{April 2009 -- March 2013}{}
